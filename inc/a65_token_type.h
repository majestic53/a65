...
static const std::set<int> A65_TOKEN_COMMAND_ABSOLUTE_INDEX_X_SET = {
	...
	A65_TOKEN_COMMAND_LDA, A65_TOKEN_COMMAND_LSR, A65_TOKEN_COMMAND_ORA, A65_TOKEN_COMMAND_ROL,
	A65_TOKEN_COMMAND_ROR, A65_TOKEN_COMMAND_SBC, A65_TOKEN_COMMAND_STA, A65_TOKEN_COMMAND_STZ,
	};
...
static const std::set<int> A65_TOKEN_COMMAND_ABSOLUTE_INDEX_Y_SET = {
	...
	A65_TOKEN_COMMAND_LDA, A65_TOKEN_COMMAND_LDX, A65_TOKEN_COMMAND_LDY, A65_TOKEN_COMMAND_ORA,
	A65_TOKEN_COMMAND_SBC, A65_TOKEN_COMMAND_STA,
	};
...
static const std::set<int> A65_TOKEN_COMMAND_ZEROPAGE_INDEX_X_SET = {
	...
	A65_TOKEN_COMMAND_CMP, A65_TOKEN_COMMAND_DEC, A65_TOKEN_COMMAND_EOR, A65_TOKEN_COMMAND_INC,
	A65_TOKEN_COMMAND_LDA, A65_TOKEN_COMMAND_LSR, A65_TOKEN_COMMAND_ORA, A65_TOKEN_COMMAND_ROL,
	A65_TOKEN_COMMAND_ROR, A65_TOKEN_COMMAND_SBC, A65_TOKEN_COMMAND_STA, A65_TOKEN_COMMAND_STY,
	A65_TOKEN_COMMAND_STZ,
	};
...
static const std::set<int> A65_TOKEN_COMMAND_ZEROPAGE_INDEX_Y_SET = {
	A65_TOKEN_COMMAND_LDX, A65_TOKEN_COMMAND_LDY, A65_TOKEN_COMMAND_STX,
	};
...
static const std::string A65_TOKEN_DIRECTIVE_STR[] = {
	".db", ".dw", ".def", ".else", ".elseif", ".endif", ".if", ".ifdef", ".ifndef", ".org", ".res", ".undef",
	};
...
enum {
	...
	A65_TOKEN_SYMBOL_OPERATOR_AND,
	A65_TOKEN_SYMBOL_OPERATOR_OR,
...
static const std::map<std::string, int> A65_TOKEN_SYMBOL_MAP = {
	...
	std::make_pair(A65_TOKEN_SYMBOL_STRING(A65_TOKEN_SYMBOL_OPERATOR_AND), A65_TOKEN_SYMBOL_OPERATOR_AND),
	std::make_pair(A65_TOKEN_SYMBOL_STRING(A65_TOKEN_SYMBOL_OPERATOR_OR), A65_TOKEN_SYMBOL_OPERATOR_OR),
